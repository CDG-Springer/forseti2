  ...
  return (
    <section className="mt-12 w-full">
      <div className="mx-auto max-w-4xl rounded-[40px] border border-black/5 dark:border-white/20 p-2 shadow-sm">
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-[#70A0A1] p-2 shadow-sm">
          {/* Subtle radial glow from center */}
          <div
            className="absolute inset-0 z-0"
            style={{
              background: "radial-gradient(ellipse 60% 40% at 50% 50%, rgba(43, 171, 119, 0.1), transparent 70%)",
            }}
          />
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Organize. Execute. Celebre com Estilo.</h2>
              <p className="text-white/60 mb-8">Construído para tornar seus eventos inesquecíveis.</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
              ...
              <div className="flex items-center justify-center">
                <a href="https://instagram.com/forsetieventos" target="_blank" rel="noopener noreferrer">
                  <div className="group border-border bg-secondary/70 flex h-[64px] cursor-pointer items-center gap-2 rounded-full border p-[11px] mt-10">
                    <div className="border-border bg-black flex h-[43px] items-center justify-center rounded-full border">
