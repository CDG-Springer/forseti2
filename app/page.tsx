...
export default function Home() {
  ...
  const products = [
    { src: "/Produtos/3x3.png", name: "Tenda 3x3" },
    { src: "/Produtos/5x5.png", name: "Tenda 5x5" },
    { src: "/Produtos/10x10.png", name: "Tenda 10x10" },
    { src: "/Produtos/Maquininha.png", name: "Maquininha" },
    { src: "/Produtos/Palco.png", name: "Palco 8x6. (Moble)" },
    { src: "/Produtos/telao.png", name: "Telão 6x4 - (2.91 outdoor)" },
  ]
          ...
          <div className="absolute top-20 left-4 right-4 bg-background/95 backdrop-blur-md border border-border/50 rounded-2xl shadow-2xl p-6">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="border-t border-border/50 pt-4 mt-4 flex flex-col space-y-3">
                <button
                  onClick={() => handleMobileNavClick("features")}
                  className="px-4 py-3 text-lg font-medium text-muted-foreground hover:text-foreground transition-colors rounded-lg hover:bg-background/50 cursor-pointer text-left"
                >
                  Começar
                </button>
              </div>
      ...
      <section id="products" className="relative z-10 mx-auto w-full max-w-6xl px-4 md:px-6 lg:px-8 mt-16">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {products.map(({ src, name }) => (
            <div
              key={name}
              className="w-full md:basis-[calc(33.333%-2rem)] lg:basis-[calc(33.333%-2rem)] flex flex-col items-center"
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={src} alt={name} className="w-full h-80"/>
